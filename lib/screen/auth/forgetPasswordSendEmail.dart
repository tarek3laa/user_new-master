          ...
          child: Column(
            children: [
             ...
             Row(
              ...
              defaultNewTextFormField(labelName: "البريد الإلكتروني المسجل", labelStar: "*", hint: " ادخل البريد الإلكتروني المسجل",horizontal: 15,suffix: Icon(Icons.email,color: Colors.grey,),validator: (String? value){
                if(value!.isEmpty){
